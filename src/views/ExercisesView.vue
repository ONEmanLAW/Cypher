...
const phases = [
  { n: '01', name: 'Discovery', exos: [{ id: '01', name: 'Kick Start', desc: 'Find your first sound.' }] },
  { n: '02', name: 'Imitation', exos: [{ id: '02', name: 'Echo Flow', desc: 'Copy what you hear.' }] },
  { n: '03', name: 'Control',   exos: [{ id: '03', name: 'Control Mode', desc: 'Master your dynamics.' }] },
  { n: '04', name: 'Timing',    exos: [
...
const STATE_PILL = { todo: 'To do', start: 'To do', current: 'In progress', done: 'Done' }
const STATE_CTA = { todo: 'Later', start: 'Start', current: 'Continue', done: 'Review' }
  ...
  <main class="home">
    ...
    <header class="nav">
      <div class="nav-left">
        ...
        <span v-if="currentSound" class="nav-sound">
...
.nav-sound em { font-style: normal; color: var(--brand); }
...
.card {
  ...
  flex: 1;
  min-height: 0;
  transition: border-color 0.22s cubic-bezier(0.2,0.9,0.25,1),
...
.card.done .card-no,
.card.done .state-pill { color: var(--state-good); }
.card.done .state-pill { border-color: var(--state-good); }
