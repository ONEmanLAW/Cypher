...
export const SOUNDS = [
  ...
  { id: 'hihat', n: '02', name: 'Hi-Hat',    sub: 'ts · ts · ts.',             label: 'Hi-hat',         unlocked: true, tips: '/tips/hi-hat.pdf', sound: '/sounds/hi-hat-sound.wav' },
  { id: 'snare', n: '03', name: 'K-Snare-outward',     sub: 'the central snap.',         label: 'K Snare inward', unlocked: true, tips: '/tips/k-snare-outward.pdf', sound: '/sounds/k-snare-outward-sound.wav' },
]
